"""
Django settings for HOSPITAL_MANAGMENT_PROJECT project.
...
SECRET_KEY = 'django-insecure-uz7xr9dn+0bsak_s6^2u_0sca%mqyeb8mez7+8w4#6m%a1n59%'
...
WSGI_APPLICATION = 'HOSPITAL_MANAGMENT_PROJECT.wsgi.application'
